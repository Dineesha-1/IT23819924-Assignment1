...
- **Numbers & Currency**: Numerical formats, currency, dates and measurements
- **Whitespace Handling**: Multiple spaces and line breaks
- **Slang & Informal Expressions**: Casual language patterns

### Negative Functional Tests (2 scenarios)

Tests for robustness including:
- Negative sentence structures
- Present tense negative statements
- Error handling for unconventional inputs

### UI Tests (4 scenarios)

- Real-time output update validation
- Dynamic translation as user types
...
- **Test Case ID**: Unique identifier (e.g., Pos_Fun_0001)
- **Name**: Descriptive test name
- **Input**: Singlish text to translate
- **Expected Output**: Expected Sinhala translation
- **Length**: Input length classification (S: ≤30 chars, M: 31-299 chars, L: ≥300 chars)
- **Status**: Pass/Fail status
- **Covered**: Test coverage areas
- **Issues**: Validation criteria and observations
...
This project is for educational purposes as part of the IT3040 - ITPM (Introduction to Testing Project Management) course assignment.

## Author

BSc (Hons) in Information Technology - Year 3 Student - IT23819924
